...
local bvc gen trabajador_base c_antiguedad salario_diario horas_sem
	...
	foreach var of varlist `bvc' {	
		eststo: reg `var' i.negative_returners i.junta , robust
	...
	*************************
	esttab using "$sharelatex/Tables/reg_results/negative_returners_balance.csv", se star(* 0.1 ** 0.05 *** 0.01) b(a2) ///
