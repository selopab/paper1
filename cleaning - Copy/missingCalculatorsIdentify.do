...
keep if missing(gananciaImputed )
keep junta exp anio
ren exp expediente
merge 1:1 junta exp anio using  "$sharelatex\DB\pilot_casefiles_wod.dta", keep(3)

export excel "$sharelatex\DB\forCalculatorP1.xlsx", replace firstr(var)