...
********** 
	...
	*Same day conciliation
	...
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls.xls", replace ctitle("Same day. P1") addtext(Court Dummies, No) ///
	...
	*Interaction employee was present
	...
	local DepVarMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls.xls", append ctitle("Same day. P1") addtext(Court Dummies, No) ///
	...
	*Same day conciliation
	...
	qui su seconcilio if e(sample)
	local DepVarMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls.xls", append ctitle("Same day. P2") addtext(Court Dummies, Yes) ///
	addstat(Dependant Variable Mean, `DepVarMean') keep(2.treatment 1.p_actor 2.treatment#1.p_actor )
	...
	*Interaction employee was present
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls.xls", append ctitle("Same day. Pooled") ///
	...
	*Interaction employee was present PROBIT SPECIFICATION
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls.xls", append ctitle("Same day. Pooled. Probit") ///
	addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean') ///
	keep(2.treatment 1.p_actor 2.treatment#1.p_actor )
	...
	*2 months
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls.xls", append ctitle("2M. Pooled") ///
	addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean') ///
	keep(2.treatment 1.p_actor 2.treatment#1.p_actor )
	...
	*5 months
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls.xls", append ctitle("5M. Pooled") ///
	addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean') ///
	keep(2.treatment 1.p_actor 2.treatment#1.p_actor )
	...
	*Long run
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls.xls", append ctitle("Long Run. Pooled") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean') keep(2.treatment 1.p_actor 2.treatment#1.p_actor )
	...
	*Same day conciliation
	...
	qui sum seconcilio if e(sample)
	local DepVarMean = r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls_imputed.xls", replace ctitle("Same day. P1") addtext(Court Dummies, No) addstat(Dependant Variable Mean, `DepVarMean') keep(2.treatment 1.p_actor 2.treatment#1.p_actor  missingCasefiles)
	...
	*Interaction employee was present
	...
	qui su seconcilio if e(sample)
	local DepVarMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls_imputed.xls", append ctitle("Same day. P1") addtext(Court Dummies, No) addstat(Dependant Variable Mean,`DepVarMean', Interaction Mean,`IntMean') keep(2.treatment 1.p_actor 2.treatment#1.p_actor  missingCasefiles)
	...
	*Same day conciliation
	...
	qui su seconcilio if e(sample)
	local DepVarMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls_imputed.xls", append ctitle("Same day. P2") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean') keep(2.treatment 1.p_actor 2.treatment#1.p_actor  missingCasefiles)
	...
	*Interaction employee was present
	...
	qui su seconcilio if e(sample)
	local DepVarMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls_imputed.xls", append ctitle("Same day. P2") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean') keep(2.treatment 1.p_actor 2.treatment#1.p_actor  missingCasefiles)
	...
	*Interaction employee was present
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls_imputed.xls", append ctitle("Same day. Pooled") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean') keep(2.treatment 1.p_actor 2.treatment#1.p_actor  missingCasefiles)
	...
	*Interaction employee was present PROBIT SPECIFICATION
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls_imputed.xls", append ctitle("Same day. Pooled. Probit") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean') keep(2.treatment 1.p_actor 2.treatment#1.p_actor  missingCasefiles)
	...
	*2 months
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls_imputed.xls", append ctitle("2M. Pooled") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean') keep(2.treatment 1.p_actor 2.treatment#1.p_actor  missingCasefiles)
	...
	*5 months
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls_imputed.xls", append ctitle("5M. Pooled") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean') keep(2.treatment 1.p_actor 2.treatment#1.p_actor  missingCasefiles)

	replace treatment = 2 if treatment==1 & T1T2 ==1
	...
	*Long run
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsTreatmentChange_controls_imputed.xls", append ctitle("Long Run. Pooled") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean') keep(2.treatment 1.p_actor 2.treatment#1.p_actor  missingCasefiles)
