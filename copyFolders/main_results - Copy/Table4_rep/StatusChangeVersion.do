...
drop if treatment==3
	...
	*Same day conciliation
	...
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsStatusChange.xls", replace ctitle("Same day. P1") addtext(Court Dummies, No) addstat(Dependant Variable Mean, `DepVarMean')
	...
	*Interaction employee was present
	...
	local DepVarMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsStatusChange.xls", append ctitle("Same day. P1") addtext(Court Dummies, No) addstat(Dependant Variable Mean,`DepVarMean', Interaction Mean,`IntMean')
	...
	*Same day conciliation
	...
	qui su seconcilio if e(sample)
	local DepVarMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsStatusChange.xls", append ctitle("Same day. P2") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean')
	...
	*Interaction employee was present
	...
	qui su seconcilio if e(sample)
	local DepVarMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsStatusChange.xls", append ctitle("Same day. P2") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean')
	...
	*Interaction employee was present
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsStatusChange.xls", append ctitle("Same day. Pooled") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean')
	...
	*Interaction employee was present PROBIT SPECIFICATION
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsStatusChange.xls", append ctitle("Same day. Pooled. Probit") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean')
	...
	*2 months
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsStatusChange.xls", append ctitle("2M. Pooled") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean')
	...
	*5 months
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsStatusChange.xls", append ctitle("5M. Pooled") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean')
	...
	*Long run
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsStatusChange.xls", append ctitle("Long Run. Pooled") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean')
