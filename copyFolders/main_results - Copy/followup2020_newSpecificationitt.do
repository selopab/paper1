...
merge 1:1 junta exp anio using "$sharelatex\p1_w_p3\out\inicialesP1Faltantes_wod.dta", keep(1 3) gen(_mNuevasIniciales) keepusing(fechaDemanda_M tipodeabogado_M )
//
...
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPV.xls", replace ctitle("asinhNPV") ///
...
reg asinhNPV i.treatment i.p_actor i.treatment#i.p_actor, robust cluster(fecha_treatment)	
	...
	qui su asinhNPV if e(sample)
	local DepVarMean=r(mean)
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPV.xls", append ctitle("asinhNPV") ///
...
reg asinhNPV i.treatment `controls', robust cluster(fecha_treatment)
	qui su asinhNPV if e(sample)
	local DepVarMean=r(mean)
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPV.xls", append ctitle("asinhNPV. Controls") ///
...
reg asinhNPV i.treatment i.missingCasefiles#(`imputedControls') missingCasefiles, robust cluster(fecha_treatment)
	qui su asinhNPV if e(sample)
	local DepVarMean=r(mean)
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPV.xls", append ctitle("asinhNPV. Imputed Controls") ///
...
reg asinhNPV i.treatment i.p_actor i.treatment#i.p_actor i.missingCasefiles#(`imputedControls') missingCasefiles, robust cluster(fecha_treatment)	
	qui su asinhNPV if e(sample) & p_actor == 1
	local IntMean=r(mean)
	qui su asinhNPV if e(sample)
	local DepVarMean=r(mean)
...
reg asinhNPVImputed i.treatment, robust cluster(fecha_treatment)
	...
	local DepVarMean=r(mean)
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPVImputed.xls", replace ctitle("asinhNPVImputed") ///
	addtext(Casefile Controls, No, Imputed Controls, No) addstat(DepVarMean, `DepVarMean') keep(2.treatment missingCasefiles 1.p_actor 2.treatment#1.p_actor) ///
	addnote("Controls: `controls'") 
...
reg asinhNPVImputed i.treatment i.p_actor i.treatment#i.p_actor, robust cluster(fecha_treatment)	
	...
	qui su asinhNPVImputed if e(sample)
	local DepVarMean=r(mean)
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPVImputed.xls", append ctitle("asinhNPVImputed") ///
addtext(Casefile Controls, No, Imputed Controls, No) addstat(DepVarMean, `DepVarMean', IntMean, `IntMean') keep(2.treatment missingCasefiles 1.p_actor 2.treatment#1.p_actor)
...
reg asinhNPVImputed i.treatment `controls' , robust cluster(fecha_treatment)
	qui su asinhNPVImputed if e(sample)
	local DepVarMean=r(mean)
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPVImputed.xls", append ctitle("asinhNPVImputed. Controls") ///
...
*5) Just treatment + imputed casefile level controls
reg asinhNPVImputed i.treatment i.missingCasefiles#(`imputedControls') missingCasefiles, robust cluster(fecha_treatment)
	qui su asinhNPVImputed if e(sample)
	local DepVarMean=r(mean)
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPVImputed.xls", append ctitle("asinhNPVImputed. Imputed Controls") ///
	addtext(Casefile Controls, No, Imputed Controls, Yes) addstat(DepVarMean, `DepVarMean') keep(2.treatment missingCasefiles 1.p_actor 2.treatment#1.p_actor)

*6) Treatment presence interaction + imputed casefile level controls
reg asinhNPVImputed i.treatment i.p_actor i.treatment#i.p_actor i.missingCasefiles#(`imputedControls') missingCasefiles, robust cluster(fecha_treatment)	
	qui su asinhNPVImputed if e(sample) & p_actor ==1
	local IntMean=r(mean)
	qui su asinhNPVImputed if e(sample)
	local DepVarMean=r(mean)
...
reg asinhNPV i.treatment, robust cluster(fecha_treatment)
	qui su asinhNPV if e(sample)
	local DepVarMean=r(mean)
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPVPrivate.xls", replace ctitle("asinhNPV") ///
	addtext(Casefile Controls, No, Imputed Controls, No) addstat(DepVarMean, `DepVarMean') keep(2.treatment missingCasefiles 1.p_actor 2.treatment#1.p_actor) ///
	addnote("Controls: `controls'") 
...
reg asinhNPV i.treatment i.p_actor i.treatment#i.p_actor, robust cluster(fecha_treatment)	
	...
	qui su asinhNPV if e(sample)
	local DepVarMean=r(mean)
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPVPrivate.xls", append ctitle("asinhNPV") ///
addtext(Casefile Controls, No, Imputed Controls, No) addstat(DepVarMean, `DepVarMean', IntMean, `IntMean')  keep(2.treatment missingCasefiles 1.p_actor 2.treatment#1.p_actor)
...
reg asinhNPV i.treatment `controls' , robust cluster(fecha_treatment)
	qui su asinhNPV if e(sample)
	local DepVarMean=r(mean)
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPVPrivate.xls", append ctitle("asinhNPV. Controls") ///
	addtext(Casefile Controls, Yes, Imputed Controls, No) addstat(DepVarMean, `DepVarMean') keep(2.treatment missingCasefiles 1.p_actor 2.treatment#1.p_actor)
...
reg asinhNPV i.treatment i.missingCasefiles#(`imputedControls') missingCasefiles, robust cluster(fecha_treatment)
	qui su asinhNPV if e(sample)
	local DepVarMean=r(mean)
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPVPrivate.xls", append ctitle("asinhNPV. Imputed Controls") ///
	addtext(Casefile Controls, No, Imputed Controls, Yes) addstat(DepVarMean, `DepVarMean') keep(2.treatment missingCasefiles 1.p_actor 2.treatment#1.p_actor)
...
reg asinhNPVImputed i.treatment, robust cluster(fecha_treatment)
	qui su asinhNPVImputed if e(sample)
	local DepVarMean=r(mean)
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPVImputedPrivate.xls", replace ctitle("asinhNPVImputed") ///
	addtext(Casefile Controls, No, Imputed Controls, No) addstat(DepVarMean, `DepVarMean') keep(2.treatment missingCasefiles 1.p_actor 2.treatment#1.p_actor) ///
	addnote("Controls: `controls'") 
...
reg asinhNPVImputed i.treatment i.p_actor i.treatment#i.p_actor, robust cluster(fecha_treatment)	
	...
	qui su asinhNPVImputed if e(sample)
	local DepVarMean=r(mean)
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPVImputedPrivate.xls", append ctitle("asinhNPVImputed") ///
addtext(Casefile Controls, No, Imputed Controls, No) addstat(DepVarMean, `DepVarMean', IntMean, `IntMean')  keep(2.treatment missingCasefiles 1.p_actor 2.treatment#1.p_actor)
...
reg asinhNPVImputed i.treatment `controls', robust cluster(fecha_treatment)
	qui su asinhNPVImputed if e(sample)
	local DepVarMean=r(mean)
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPVImputedPrivate.xls", append ctitle("asinhNPVImputed. Controls") ///
	addtext(Casefile Controls, Yes, Imputed Controls, No) addstat(DepVarMean, `DepVarMean') keep(2.treatment missingCasefiles 1.p_actor 2.treatment#1.p_actor)
...
reg asinhNPVImputed i.treatment i.missingCasefiles#(`imputedControls') missingCasefiles, robust cluster(fecha_treatment)
	qui su asinhNPVImputed if e(sample)
	local DepVarMean=r(mean)
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPVImputedPrivate.xls", append ctitle("asinhNPVImputed. Imputed Controls") ///
	addtext(Casefile Controls, No, Imputed Controls, No) addstat(DepVarMean, `DepVarMean') keep(2.treatment missingCasefiles 1.p_actor 2.treatment#1.p_actor)
