...
putexcel clear
putexcel set "$sharelatex/Tables/Table8_assessUnconfoundedness_rep.xlsx", sheet("balance_match") modify
...
local Col=substr(c(ALPHA),2*`i'-1,1)
putexcel clear
putexcel set "$sharelatex/Tables/Table8_assessUnconfoundedness_rep.xlsx", sheet("NN_match") modify
