...
outreg2 using "$sharelatex\Tables\reg_results\December2018Followup_asinhNPVChangePrivate.xls", replace ctitle("asinhNPV") ///
	addtext(BVC, No) addstat(DepVarMean, `DepVarMean') keep(2.treatment missingCasefiles 1.p_actor 2.treatment#1.p_actor)
...
addtext(BVC, No) addstat(DepVarMean, `DepVarMean', IntMean, `IntMean')  keep(2.treatment missingCasefiles 1.p_actor 2.treatment#1.p_actor)
