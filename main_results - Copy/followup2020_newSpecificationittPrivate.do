...
gen fechaTerminoAux = date("$dateCode", "YMD")
...
reg asinhNPV i.treatment fechaDemanda i.tipodeabogado i.trabajador_base, robust cluster(fecha_treatment)
	qui su asinhNPV if e(sample)
	local DepVarMean=r(mean)
...
reg asinhNPV i.treatment i.p_actor i.treatment#i.p_actor fechaDemanda i.tipodeabogado i.trabajador_base, robust cluster(fecha_treatment)	
	qui su asinhNPV if e(sample) & p_actor == 1
	local IntMean=r(mean)
	qui su asinhNPV if e(sample)
	local DepVarMean=r(mean)
...
reg asinhNPV i.treatment c.order#i.missingCasefiles i.tipodeabogadoImputed#i.missingCasefiles i.trabajador_baseImputed#i.missingCasefiles missingCasefiles, robust cluster(fecha_treatment)
	qui su asinhNPV if e(sample)
	local DepVarMean=r(mean)
...
reg asinhNPV i.treatment i.p_actor i.treatment#i.p_actor c.order#i.missingCasefiles i.tipodeabogadoImputed#i.missingCasefiles i.trabajador_baseImputed#i.missingCasefiles missingCasefiles, robust cluster(fecha_treatment)	
	qui su asinhNPV if e(sample) & p_actor == 1
	local IntMean=r(mean)
	qui su asinhNPV if e(sample)
	local DepVarMean=r(mean)
...
*3) Just treatment + casefile level controls
reg asinhNPVImputed i.treatment fechaDemanda i.tipodeabogado i.trabajador_base, robust cluster(fecha_treatment)
	qui su asinhNPVImputed if e(sample)
	local DepVarMean=r(mean)
...
*4) Treatment presence interaction + casefile level controls
reg asinhNPVImputed i.treatment i.p_actor i.treatment#i.p_actor fechaDemanda i.tipodeabogado i.trabajador_base, robust cluster(fecha_treatment)	
	qui su asinhNPVImputed if e(sample) & p_actor ==1
	local IntMean=r(mean)
	qui su asinhNPVImputed if e(sample)
	local DepVarMean=r(mean)
...
*5) Just treatment + imputed casefile level controls
reg asinhNPVImputed i.treatment c.order#i.missingCasefiles i.tipodeabogadoImputed#i.missingCasefiles i.trabajador_baseImputed#i.missingCasefiles missingCasefiles, robust cluster(fecha_treatment)
	qui su asinhNPVImputed if e(sample)
	local DepVarMean=r(mean)
...
*6) Treatment presence interaction + imputed casefile level controls
reg asinhNPVImputed i.treatment i.p_actor i.treatment#i.p_actor c.order#i.missingCasefiles i.tipodeabogadoImputed#i.missingCasefiles i.trabajador_baseImputed#i.missingCasefiles missingCasefiles, robust cluster(fecha_treatment)	
	qui su asinhNPVImputed if e(sample) & p_actor ==1
	local IntMean=r(mean)
	qui su asinhNPVImputed if e(sample)
	local DepVarMean=r(mean)
