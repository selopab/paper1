...
outreg2 using "$sharelatex/Tables/reg_results/astracango.xls", replace ctitle("OLS FS")

*Probit (FS)
probit p_actor i.treatment time_instrument i.junta, r cluster(fecha)
outreg2 using "$sharelatex/Tables/reg_results/astracango.xls", append ctitle("Probit FS")
...
outreg2 using "$sharelatex/Tables/reg_results/astracango.xls", append ctitle("CF Probit") addstat(DepVarMean, `DepVarMean', IntMean, `IntMean')
