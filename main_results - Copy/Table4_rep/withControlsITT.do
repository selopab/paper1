...
********** 
	...
	*Interaction employee was present
	...
	qui su p_actor if e(sample)
	local IntMean=r(mean)
	outreg2 using  "$sharelatex/Tables/reg_results/treatment_effectsITT_controls_imputed.xls", append ctitle("Same day. Pooled") addtext(Court Dummies, Yes) addstat(Dependant Variable Mean, `DepVarMean', Interaction Mean,`IntMean') keep(2.treatment 1.p_actor 2.treatment#1.p_actor  missingCasefiles)
