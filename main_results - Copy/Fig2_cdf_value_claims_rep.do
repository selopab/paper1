...
merge m:1 mes anio using "$sharelatex/Raw/inpc.dta", nogen keep(1 3) //indice nacional de precios
...
graph export "$sharelatex\Figures\cdf_pdf_value_claims.pdf", replace 
